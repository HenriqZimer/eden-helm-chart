...
When deploying Eden using this Helm chart:
...
4. **Updates**
   ...
   - Monitor security advisories for the upstream [linuxserver/docker-eden](https://github.com/linuxserver/docker-eden) image.
